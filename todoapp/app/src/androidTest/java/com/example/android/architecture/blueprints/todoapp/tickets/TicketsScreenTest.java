...
@LargeTest
public class TicketsScreenTest {
     ...
     */
    @Rule
    public ActivityTestRule<TicketsActivity> mTasksActivityTestRule =
            new ActivityTestRule<TicketsActivity>(TicketsActivity.class) {

                /**
                 * To avoid a long list of tasks and the need to scroll through the list to find a
                 * task, we call {@link TicketsDataSource#deleteAllTickets()} before each test.
                 */
                @Override
                protected void beforeActivityLaunched() {
                    super.beforeActivityLaunched();
                    // Doing this in @Before generates a race condition.
                    Injection.provideTicketsRepository(InstrumentationRegistry.getTargetContext())
                        .deleteAllTickets();
                }
            };
