...
@LargeTest
public class AddEditTicketScreenTest {
     ...
     */
    @Rule
    public ActivityTestRule<AddEditTicketActivity> mActivityTestRule =
            new ActivityTestRule<>(AddEditTicketActivity.class, false, false);
    ...
    public void toolbarTitle_editTask_persistsRotation() {
        ...
        FakeTicketsRemoteDataSource.getInstance().addTasks(new Ticket("Title1", "", TASK_ID, false));
    ...
    private void launchNewTaskActivity(@Nullable String taskId) {
        Intent intent = new Intent(InstrumentationRegistry.getInstrumentation()
                .getTargetContext(), AddEditTicketActivity.class);
